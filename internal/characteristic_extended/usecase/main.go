...
func (usecase *Usecase) Sync() error {
	...
	var (
		...
		entries []entity.CharacteristicExtended
	)
...
func (usecase Usecase) Fetch(l, o int) ([]entity.CharacteristicExtended, error) {

	var (
		responseData entity.ResponseData[entity.CharacteristicExtended]
	)
	...
	if response, err = request.Get("characteristic_values/"); err != nil {
...
func (usecase Usecase) Find(id int) (*entity.CharacteristicExtended, error) {

	return usecase.repository.Find(id)
}

func (usecase Usecase) Save(entries []entity.CharacteristicExtended) error {
